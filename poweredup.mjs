...
var entry = {
  ...
  extensionId: 'powereddown',
  collaborator: 'bricklife',
  iconURL: img$3,
  insetIconURL: img$2,
  description: /*#__PURE__*/React.createElement(FormattedMessage, {
    defaultMessage: "Build with motors and sensors.",
    id: "gui.extension.powereddown.description"
  }),
  featured: true,
  disabled: false,
...
var extensionURL = 'https://bricklife.com/scratch-gui/xcratch/powereddown.mjs';
var Scratch3powereddownBlocks = /*#__PURE__*/function (_BleBaseBlocks) {
  _inherits(Scratch3powereddownBlocks, _BleBaseBlocks);
  function Scratch3powereddownBlocks(runtime) {
    var _this;
    _classCallCheck(this, Scratch3powereddownBlocks);
    _this = _callSuper(this, Scratch3powereddownBlocks, [new Hub(runtime, Scratch3powereddownBlocks.EXTENSION_ID, 0x41)]);
  ...
  _createClass(Scratch3powereddownBlocks, [{
    key: "externalPorts",
    get: function get() {
      return ['A', 'B'];
    }
    ...
    value: function getInfo() {
      ...
      return {
        id: Scratch3powereddownBlocks.EXTENSION_ID,
        name: 'Powered UP',
        extensionURL: Scratch3powereddownBlocks.extensionURL,
  ...
  return Scratch3powereddownBlocks;
}(BleBaseBlocks);
var blockClass = Scratch3powereddownBlocks;
blockClass = Scratch3powereddownBlocks;
